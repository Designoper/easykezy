    ...
    if (snapshot.exists()) {
        ...
        for (const element in gameList) {
            ...
            <article>
				...
				<button class="secondary card-buttons" onclick="addToCart('${element}')"><svg width="16" height="17" viewBox="0 0 16 17" fill="none"
				...
				<button class="primary" onclick="gotoCart('${element}')">comprar ahora</button>
			</article>
            `
        }
